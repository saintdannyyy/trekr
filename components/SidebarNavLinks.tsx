...
const NAV = [
  { href: "/dashboard", label: "All applications", icon: "▤", exact: true, s: null },
  { href: "/dashboard?s=Applied", label: "Applied", icon: "◎", s: "Applied" },
  { href: "/dashboard?s=Interview", label: "Interviews", icon: "◷", s: "Interview" },
  { href: "/dashboard?s=Offer", label: "Offers", icon: "✦", s: "Offer" },
  { href: "/dashboard?s=Watching", label: "Watching", icon: "◉", s: "Watching" },
  { href: "/dashboard?s=Rejected", label: "Rejected", icon: "✕", s: "Rejected" },
  { href: "/dashboard?s=Ghosted", label: "Ghosted", icon: "◌", s: "Ghosted" },
  { href: "/dashboard?s=Closed", label: "Closed / Missed", icon: "—", s: "Closed" },
];

export default function SidebarNavLinks({ customStatuses = [] }: { customStatuses?: string[] }) {
